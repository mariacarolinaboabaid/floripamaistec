...
namespace exerciciosAPI.Migrations
{
    ...
    [Migration("20230830121219_InitialCreate")]
            ...
            modelBuilder.Entity("exerciciosAPI.Models.DetalheModel", b =>
                {
                    ...
                    b.Property<DateTime>("DataCadastro")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 9, 12, 19, 336, DateTimeKind.Local).AddTicks(8200));
            ...
            modelBuilder.Entity("exerciciosAPI.Models.FichaModel", b =>
                {
                    ...
                    b.Property<DateTime>("DataCadastro")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 8, 30, 9, 12, 19, 336, DateTimeKind.Local).AddTicks(8390));
